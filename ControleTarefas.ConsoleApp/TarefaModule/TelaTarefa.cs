...
namespace eAgenda.ConsoleApp.TarefaModule
{
    public class TelaTarefa : TelaBase
    {
        ...
        private string ConcluirTarefa(int id, out int porcentagemConluido, out Tarefa tarefa,
            List<Tarefa> qtdDeRegistrosAntesDeAdicionarNovaTarefa, List<Tarefa> qtdDeRegistrosDepoisDeAdicionarNovaTarefa,
            string titulo, int prioridade, out DateTime dataConclusao)
        {
        ...
        private static string VerificaSeFoiAdicionado(List<Tarefa> qtdDeRegistrosAntesDeAdicionarNovaTarefa, 
            List<Tarefa> qtdDeRegistrosDepoisDeAdicionarNovaTarefa)
        {
